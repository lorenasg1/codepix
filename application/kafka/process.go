...
import (
	...
	"github.com/lorenasg1/codepix/application/factory"
	appmodel "github.com/lorenasg1/codepix/application/model"
...
func (k *KafkaProcessor) Consume() {
	configMap := &ckafka.ConfigMap{
		"bootstrap.servers": os.Getenv("KAFKA_rocessor_SERVERS"),
